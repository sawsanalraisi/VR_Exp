...
public class EnterAndExitCar : MonoBehaviour
{
    ...
    public void OnTriggerEnter(Collider other)
    {
        ...
        if (other.tag == "ExitToCarTag")
        {
            ...
            // transform.position = new Vector3(7.038f, 0.111f, 0.191f);
            // transform.position = new Vector3(7.041f, 0.116f, -0.153f);
             transform.position = new Vector3(2.98f, 0.1f, 7.77f);


            if (IsRotate)
            {
                //transform.Rotate(0, -100, 0);
                //transform.Rotate(0, -16, 0);
                transform.Rotate(0, -89f, 0);
